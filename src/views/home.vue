<template>
    <div class="home-container select-none">
        <div class="content">
            <div class="text">
                <h2 class="title">
                    一次温暖的对话<br />
                ...
                <div class="hero-actions">
                    ...
                    <el-button size="large" class="border-[#fff] bg-transparent text-[#fff]"
                        >记录心情，释放情感</el-button
                    >
                </div>
            </div>
            <div class="robot">
                <el-image class="robot-image w-[150px] h-[150px]" :src="imgUrl"></el-image>
            </div>
        </div>
    </div>
</template>
...
.home-container {
    ...
    padding: 2rem 2rem;
    // ===== 删除原来 height: calc(...) =====
    flex: 1; /* 核心：自动占据header和footer之间所有高度 */
    display: flex;
    align-items: center;
    justify-content: center;
